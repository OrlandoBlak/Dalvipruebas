...
<head>
    ...
    <title>Evaluación – Grupo Dalvi</title>
...
<main class="main-content" id="mainContent">
    ...
    <header class="topbar">
        ...
        <div class="topbar-right">
            <button class="btn-secondary" onclick="window.location.href='homeuser.php'">← Volver</button>
        </div>
    </header>
        ...
        <div class="eval-left">
            ...
            <div class="eval-card">
                ...
                <div class="insignias-lista" id="insigniasList">
                    ...
                    <p class="eval-hint">No hay insignias configuradas.</p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="eval-acciones">
                <button class="btn-modal-cancel" onclick="window.location.href='homeuser.php'">Cancelar</button>
